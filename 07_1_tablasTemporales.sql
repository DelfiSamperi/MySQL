-- TABLAS TEMPORALES
-- Utiliza TABLE para consultar la tabla productos de manera simple, ordenando los productos de forma 
-- descendente por precio y solo 10 filas.
...
-- Crea una tabla temporal escuela primaria que tenga las siguientes columnas: id(int), nombre(varchar), 
-- apellido(varchar), edad(int) y grado(int). Y que tenga los siguientes valores:
...
-- Crea una tabla temporal escuela secundaria que tenga las siguientes columnas: id(int), nombre(varchar), 
-- apellido(varchar), edad(int) y grado(int). Y que tenga los siguientes valores:
...
-- Realiza la excepción de la escuela primaria con la secundaria para saber quienes no siguieron cursando en 
...
-- Realiza la unión de la escuela primaria y secundaria con la columna grado para saber cuáles son los grados que 
-- abarcan ambas escuelas, y ordénalos de forma descendente.
